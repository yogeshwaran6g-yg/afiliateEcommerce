  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3 mb-6">
        <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-primary/80 text-white font-bold shadow-lg shadow-primary/20">
          3
        </div>
          ...
          <div className="space-y-3">
            ...
            >
              <div className="flex items-center gap-4">
                <div
                  className={`w-12 h-12 rounded-xl flex items-center justify-center ${paymentType === "upi" ? "bg-primary text-white" : "bg-slate-100 text-primary"}`}
                >
            ...
            >
              <div className="flex items-center gap-4">
                <div
                  className={`w-12 h-12 rounded-xl flex items-center justify-center ${paymentType === "bank" ? "bg-primary text-white" : "bg-slate-100 text-primary"}`}
                >
                  <span className="material-symbols-outlined text-2xl">
                    account_balance
                  </span>
