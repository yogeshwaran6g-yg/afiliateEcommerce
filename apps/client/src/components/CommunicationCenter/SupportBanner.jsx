...
const SupportBanner = () => {
    return (
        <div className="mt-8 bg-primary/5 rounded-2xl p-6 flex flex-col sm:flex-row items-center sm:items-start md:items-center gap-4 sm:gap-6 border border-primary/10 text-center sm:text-left">
            ...
            <button className="w-full sm:w-auto bg-white border border-slate-200 px-5 py-2 rounded-lg text-sm font-bold whitespace-nowrap hover:bg-slate-50 transition-colors">
                Contact Support
            </button>
        </div>
    );
