...
const WithdrawalFilters = ({ searchTerm, setSearchTerm, activeFilter, setActiveFilter, counts }) => {
    const tabs = [
        { label: 'All', value: 'All', count: counts.all },
        { label: 'Pending', value: 'Review Pending', count: counts.pending },
        { label: 'Approved', value: 'Approved', count: counts.disbursed },
        { label: 'Rejected', value: 'Rejected', count: counts.voided }
    ];
