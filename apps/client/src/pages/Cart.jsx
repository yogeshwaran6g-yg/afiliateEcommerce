                    ...
                    <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-2 md:gap-8 flex-1">
                            <div className="flex items-center gap-2">
                                <span className="material-symbols-outlined text-xl md:text-2xl text-orange-500">widgets</span>
                                <span className="text-base md:text-lg font-bold text-slate-900 hidden sm:inline">MLM Pro Dashboard</span>
                            </div>
                        ...
                        <div className="flex items-center gap-2 md:gap-6">
                            ...
                            <button className="p-2 hover:bg-slate-100 rounded-lg relative hidden sm:block">
                                <span className="material-symbols-outlined text-slate-600">notifications</span>
                            </button>
                            <button className="p-2 hover:bg-slate-100 rounded-lg hidden sm:block">
                                <span className="material-symbols-outlined text-slate-600">help</span>
                            </button>
                            <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-br from-amber-400 to-amber-600 rounded-full flex items-center justify-center text-white font-bold border-2 border-orange-200 text-sm">
                                U
                            </div>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8 py-4 md:py-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
                        ...
                        <div className="lg:col-span-2">
                            <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
                                ...
                                <div className="divide-y divide-slate-200">
                                    {cartItems.map((item) => (
                                        <div key={item.id} className="p-4 md:grid md:grid-cols-12 md:gap-4 md:px-6 md:py-6 md:items-center">
                                            {/* Mobile Layout */}
                                            <div className="md:hidden space-y-4">
                                                <div className="flex gap-4">
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        <div className="text-lg font-bold text-slate-900 mt-2">${item.price.toFixed(2)}</div>
                                                    </div>
                                                    <button
                                                ...
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <div className="text-center">
                                                        <div className="text-sm font-bold text-orange-600">{item.pv * item.quantity} PV</div>
                                                    </div>
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-white rounded-2xl border border-slate-200 p-4 md:p-6 lg:sticky lg:top-8">
                                <h2 className="text-lg md:text-xl font-bold text-slate-900 mb-4 md:mb-6">Order Summary</h2>

                                {/* Price Breakdown */}
                                <div className="space-y-3 mb-4 md:mb-6 pb-4 md:pb-6 border-b border-slate-200">
                                ...
                                {/* Total PV */}
                                <div className="bg-orange-50 rounded-xl p-3 md:p-4 mb-4 md:mb-6">
                                    <div className="flex justify-between items-center mb-2">
                                        <span className="text-xs md:text-sm font-semibold text-slate-700">Total PV Earned</span>
                                        <span className="text-xl md:text-2xl font-bold text-orange-600">{totalPV} PV</span>
                                    </div>
                                ...
                                {/* Grand Total */}
                                <div className="flex justify-between items-center mb-4 md:mb-6 pb-4 md:pb-6 border-b border-slate-200">
                                ...
                                {/* Proceed Button */}
                                <button className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 md:py-4 rounded-xl flex items-center justify-center gap-2 transition-all mb-4">
                                    Proceed to Payment
                ...
                <footer className="bg-white border-t border-slate-200 mt-auto py-6">
                    <div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-slate-500">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-center md:text-left">2024 MLM Pro Platform. All rights reserved.</span>
                        </div>
