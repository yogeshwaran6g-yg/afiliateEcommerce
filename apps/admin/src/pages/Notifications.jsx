        ...
        <div className="p-4 md:p-8 lg:p-12 space-y-6 md:space-y-10">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="space-y-3 md:space-y-4">
                    ...
                    <h2 className="text-2xl md:text-5xl font-black text-[#172b4d] tracking-tighter">System Alerts</h2>
                ...
                <div className="flex items-center gap-3">
                    <button
                        ...
                        className="w-full md:w-auto px-6 py-3 text-slate-600 text-sm font-black hover:bg-slate-50 rounded-2xl transition-all border border-slate-100 shadow-sm flex items-center justify-center gap-2"
                    >
