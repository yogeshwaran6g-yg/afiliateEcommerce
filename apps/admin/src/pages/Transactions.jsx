            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="space-y-4">
                    <div className="flex items-center gap-2 text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none">
                        ...
                        <span className="text-primary">Transaction Logs</span>
                    </div>
                    <h2 className="text-3xl md:text-4xl font-black text-[#172b4d] tracking-tight">Ledger Operations</h2>
                    <p className="text-sm md:text-lg text-slate-500 font-medium">Monitoring real-time financial movements across the entire MLM ecosystem.</p>
                </div>
                    ...
                    <div className="flex flex-wrap items-center gap-2 p-1.5 bg-slate-50 border border-slate-200 rounded-2xl">
                        {["All", "Credit", "Debit", "Transfer"].map(tab => (
                            <button
                                ...
                                className={`px-5 py-2 rounded-xl text-[10px] md:text-xs font-black uppercase tracking-widest transition-all ${activeFilter === tab ? 'bg-white text-primary shadow-sm border border-slate-100' : 'text-slate-400 hover:text-slate-600'
                                    }`}
                            >
                                {tab}
                            </button>
                    ...
                    <div className="flex items-center gap-3">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="pl-11 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-[11px] font-bold text-[#172b4d] focus:outline-none focus:ring-2 focus:ring-primary/20 w-64"
                            />
                        </div>
