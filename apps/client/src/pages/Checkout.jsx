            ...
            <header className="bg-white border-b border-slate-200 px-8 py-4">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    ...
                    <nav className="flex items-center gap-8">
                        ...
                        <Link to="/network" className="text-sm font-medium text-slate-600 hover:text-primary">Network</Link>
                        <Link to="/products" className="text-sm font-medium text-slate-600 hover:text-primary">Products</Link>
                        <Link to="/earnings" className="text-sm font-medium text-slate-600 hover:text-primary">Earnings</Link>
                    </nav>
                ...
                <div className="max-w-3xl mx-auto px-8">
                    <div className="flex items-center justify-between relative">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <span className="text-xs font-semibold text-slate-400 uppercase">Cart</span>
                        </div>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <span className="text-xs font-semibold text-slate-400 uppercase">Shipping</span>
                        </div>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <span className="text-xs font-bold text-primary uppercase">Payment</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500">Complete your transaction by selecting an address and payment method.</p>
                        </div>
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <button className="text-primary text-sm font-semibold hover:underline">Add New Address</button>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                >
                                    ...
                                    <p className="text-sm text-slate-500">123 Business Parkway, Suite 100</p>
                                    <p className="text-sm text-slate-500">Manhattan, New York, 10001</p>
                                ...
                                >
                                    ...
                                    <p className="text-sm text-slate-500">456 Enterprise Drive</p>
                                    <p className="text-sm text-slate-500">Austin, Texas, 73301</p>
                                    <p className="text-sm text-slate-500">United States</p>
                                </button>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="bg-slate-50 rounded-xl p-4 mb-6 flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="font-bold text-slate-900">Use Wallet Balance</h3>
                                        <p className="text-sm text-slate-500">Current Balance: <span className="text-success font-semibold">${walletBalance.toFixed(2)}</span></p>
                                    </div>
                                </div>
                                <button
                                    onClick={() => setUseWallet(!useWallet)}
                                    className={`relative w-12 h-6 rounded-full transition-colors ${useWallet ? "bg-primary" : "bg-slate-300"
                                        }`}
                                >
                                    <div className={`absolute top-0.5 w-5 h-5 bg-white rounded-full transition-transform ${useWallet ? "translate-x-6" : "translate-x-0.5"
                                        }`}></div>
                                </button>
                            </div>
                            ...
                            <div className="grid grid-cols-3 gap-4 mb-6">
                                ...
                                <button
                                    ...
                                    className={`p-4 rounded-xl border-2 flex flex-col items-center gap-2 transition-all ${paymentMethod === "bank"
                                            ? "border-primary bg-primary/5"
                                            : "border-slate-200 hover:border-slate-300"
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`p-4 rounded-xl border-2 flex flex-col items-center gap-2 transition-all ${paymentMethod === "crypto"
                                            ? "border-primary bg-primary/5"
                                            : "border-slate-200 hover:border-slate-300"
                                        }`}
                                >
                                    <span className="material-symbols-outlined text-2xl text-slate-400">currency_bitcoin</span>
                                    <span className="text-sm font-semibold text-slate-900">Crypto Pay</span>
                                </button>
                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                type="text"
                                                placeholder="**** **** **** 4421"
                                                className="w-full pl-12 pr-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary"
                                            />
                                        </div>
                                    </div>
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white rounded-2xl border border-slate-200 p-6 sticky top-8">
                            ...
                            <div className="space-y-4 mb-6 pb-6 border-b border-slate-200">
                                <div className="flex gap-3">
                                    ...
                                    <div className="flex-1">
                                        <h3 className="font-semibold text-slate-900 text-sm">Premium Distributor Kit</h3>
                                ...
                                <div className="flex gap-3">
                                    <div className="w-16 h-16 bg-slate-100 rounded-lg"></div>
                                    <div className="flex-1">
                                        <h3 className="font-semibold text-slate-900 text-sm">Digital Marketing Suite</h3>
                                        <p className="text-xs text-slate-500">Qty: 1</p>
                                    </div>
                            ...
                            <div className="space-y-3 mb-6 pb-6 border-b border-slate-200">
                                ...
                                {useWallet && (
                                    <div className="flex justify-between text-sm">
                                        <span className="text-primary">Wallet Credit</span>
                            ...
                            {/* Place Order Button */}
                            <button className="w-full bg-primary hover:bg-primary/90 text-white font-bold py-4 rounded-xl flex items-center justify-center gap-2 transition-all mb-4">
                            ...
                            <div className="flex items-center justify-center gap-2 text-xs text-slate-500 mb-6">
                                ...
                                <span className="font-semibold">GOOGLE GUARANTEE</span>
                                <span>100% GUARANTEED</span>
                            </div>

                            {/* Support */}
                            <div className="bg-slate-50 rounded-lg p-4 text-center">
                                <p className="text-sm text-slate-600 mb-2">Need help with your order? Contact our distributor support line at</p>
                                <a href="tel:1-800-FINTECH" className="text-primary font-bold text-sm hover:underline">1-800-FINTECH</a>
                                <span className="text-slate-500 text-sm"> or visit our help center.</span>
                            </div>
                        </div>
                    </div>
                </div>
