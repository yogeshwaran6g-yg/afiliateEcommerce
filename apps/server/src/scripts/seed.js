...
const seed = async (connection) => {
  ...
  const sampleNotifications = [
    ['Welcome to AfiliateEcom', 'Success comes to those who wait.', 'We are happy to have you here. Explore our wide range of products and start your journey with us today!', null, '2026-12-31 23:59:59'],
    ['Big Winter Sale!', 'Up to 50% off on all winter wear.', 'Grab the best deals of the season. Limited time offer on all premium winter collections including jackets, sweaters and more.', 'https://images.unsplash.com/photo-1511943044008-e93f7bb9721d', '2026-02-28 23:59:59'],
    ['New Arrivals in Electronics', 'Check out the latest gadgets.', 'Stay ahead with our newest collection of smartphones, laptops and accessories. High performance guaranteed.', null, '2026-03-15 23:59:59']
  ];
